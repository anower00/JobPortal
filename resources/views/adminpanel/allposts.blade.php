              ...
              <tr>
                  ...
                  <td>
                    ...
                    <li class="m_2">
                        ...
                        @csrf
                        {{method_field('DELETE')}}
                        <button class="" style="background:transparent;border: 0;padding: 0px 19px;color:#000;" onclick="return confirm('Are you sure you want to delete this post?')"><i class="fa fa-ban"></i> Delete</button>
                        </form>
